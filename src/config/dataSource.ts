...
export const GAS_URLS: Record<Category, string> = {
  organic: import.meta.env.VITE_GAS_URL_ORGANIC || 'https://script.google.com/macros/s/AKfycbzOWZfXHS5kznhJwipjE7RAUTC13jKH5I-vqNjfxbqRjNNz_8tGXF8R7t4TJPq4_YKKaA/exec',
  inorganic: import.meta.env.VITE_GAS_URL_INORGANIC || 'https://script.google.com/macros/s/AKfycbzOWZfXHS5kznhJwipjE7RAUTC13jKH5I-vqNjfxbqRjNNz_8tGXF8R7t4TJPq4_YKKaA/exec',
};
